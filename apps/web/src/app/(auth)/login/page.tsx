...
export default function LoginPage() {
  ...
  async function handleGoogleLogin() {
    ...
    const authUrl = `https://accounts.google.com/o/oauth2/v2/auth?client_id=${googleClientId}&redirect_uri=${redirectUri}&response_type=id_token&scope=openid%20email%20profile&nonce=${crypto.randomUUID()}`;
